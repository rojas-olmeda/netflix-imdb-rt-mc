// ==UserScript==
// @name         Puntajes Netflix Reloaded
// @version      0.1
...
// @updateURL    https://github.com/rojas-olmeda/netflix-imdb-rt-mc/raw/master/puntajes-netflix-reloaded.user.js
// @downloadURL  https://github.com/rojas-olmeda/netflix-imdb-rt-mc/raw/master/puntajes-netflix-reloaded.user.js
// ==/UserScript==
        ...
        if (url != location.href) {
            ...
            setTimeout(function() {
                ...
                $('<a>').attr('href', imdb).attr('target', '_blank').addClass('slnk')
                    .html('<img src="https://raw.githubusercontent.com/rojas-olmeda/netflix-imdb-rt-mc/master/imdb-favicon.ico">')
                ...
                $('<a>').attr('href', mc).attr('target', '_blank').addClass('slnk')
                    .html('<img src="https://raw.githubusercontent.com/rojas-olmeda/netflix-imdb-rt-mc/master/mc-favicon.ico">')
                        .appendTo('div.meta:last');
                var rt = 'https://www.rottentomatoes.com/search/?search=' + title;
                $('<a>').attr('href', rt).attr('target', '_blank').addClass('slnk')
                    .html('<img src="https://raw.githubusercontent.com/rojas-olmeda/netflix-imdb-rt-mc/master/rt-favicon.ico">')
                        .appendTo('div.meta:last');
            }, 1100);
        }
    }, 300);
